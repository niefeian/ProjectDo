...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NFASubprojects/NFASubprojects.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ProjectDo/ProjectDo.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/STRIAPManagerUtils/STRIAPManagerUtils.framework"
