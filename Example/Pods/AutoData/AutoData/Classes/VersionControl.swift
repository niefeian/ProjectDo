...
open class VersionControl {
  ...
  public  class func update() {
    ...
    class func updateVersion1() {
        _ = SQLiteDB.sharedInstance().execute("CREATE TABLE IF NOT EXISTS  josn_table(id VARCHAR(36) PRIMARY KEY NOT NULL , type VARCHAR(120) , key VARCHAR(100) , json VARCHAR(2000));")
